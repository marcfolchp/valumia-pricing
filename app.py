...
# --- Title ---
st.markdown('<div class="pricing-title">Pricing</div>', unsafe_allow_html=True)
...
with col1:
    st.markdown('<span class="input-label">Suppliers (s)</span>', unsafe_allow_html=True)
    s = st.number_input(" ", min_value=1, value=100, step=10, key="suppliers")
with col2:
    st.markdown('<span class="input-label">Keywords (k)</span>', unsafe_allow_html=True)
...
col_exa, col_google, col_rapidapi = st.columns(3)
for col, company in zip([col_exa, col_google, col_rapidapi], companies):
    ...
    with col:
        ...
        <div class="pricing-card">
            ...
            <div class="dynamic-price">{dynamic_price:.2f}€ / month</div>
